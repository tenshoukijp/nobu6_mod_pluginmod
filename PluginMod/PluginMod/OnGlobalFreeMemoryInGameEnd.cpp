...
void WriteAsmJumperOnTenshouExeGlobalFreeMemoryInGameEnd() {
	...
	WriteProcessMemory( GetCurrentProcess(), (LPVOID)(pTenshouExeJumpFromToOnTenshouExeGlobalFreeMemoryInGameEnd), cmdOnTenshouExeJumpFromGlobalFreeMemoryInGameEnd, 5, NULL); //5バイトのみ書き込む
}
