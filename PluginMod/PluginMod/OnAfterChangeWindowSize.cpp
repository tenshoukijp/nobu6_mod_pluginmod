...
void WriteAsmJumperOnTenshouExeAfterChangeWindowSize() {
	...
	WriteProcessMemory( GetCurrentProcess(), (LPVOID)(pTenshouExeJumpFromToOnTenshouExeAfterChangeWindowSize), cmdOnTenshouExeJumpFromAfterChangeWindowSize, 5, NULL); //5バイトのみ書き込む
}
