...
void WriteAsmJumperOnTenshouExeSelectingScenario() {
	...
	WriteProcessMemory( GetCurrentProcess(), (LPVOID)(pTenshouExeJumpFromToOnTenshouExeSelectingScenario), cmdOnTenshouExeJumpFromSelectingScenario, 5, NULL); //5バイトのみ書き込む
}
