...
void WriteAsmJumperOnTenshouExeViewingScenarioTitleList() {
	...
	WriteProcessMemory( GetCurrentProcess(), (LPVOID)(pTenshouExeJumpFromToOnTenshouExeViewingScenarioTitleList), cmdOnTenshouExeJumpFromViewingScenarioTitleList, 5, NULL); //5バイトのみ書き込む
}
